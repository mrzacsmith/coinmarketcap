...
# Use web site https://coinmarketcap.com/api/
...
# quotes = results['data']['quotes']['USD']['total_market_cap']
# print(quotes)
...
print('The global cap of all cryptos is ' + global_cap_string + ' and the 24 global volume is ' + global_volume_string)
